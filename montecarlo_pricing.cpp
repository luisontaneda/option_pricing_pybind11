...
double m_c_pricing(function<double(mt19937)> stoch_p, double S_t, double K, double tau, double r, int n_sims, string CP)
{
    ...
    double mean_sims = exp(-r*tau) * calculate_mean(arr, n_sims);
